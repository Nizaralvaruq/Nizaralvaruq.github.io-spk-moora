...
<head>
  ...
  <title>SPK - PENERIMAAN BANTUAN RUMAH LAYAK HUNI</title>
  ...
  <section id="container">
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a href="index.php?module=list_penduduk">List Penduduk</a></li>
              <li><a href="index.php?module=tambah_penduduk">Tambah Penduduk</a></li>
              <li><a href="index.php?module=hapus_semua_penduduk">Hapus Data Penduduk</a></li>
            </ul>
          </li>
          <li class="">
            <a class="" href="index.php?module=list_hasil">
        ...
        <div class="row">
          <div class="col-lg-12 main-chart" style="padding-left: 50px;padding-right: 50px;">
            ...
            <div class="border-head">
              <h3>PENERIMA BANTUAN RUMAH LAYAK HUNI</h3>
            </div>
            <?php
            ...
            } elseif ($_GET['module'] == 'list_penduduk') {
                include "pages/penduduk/list_penduduk.php";
            } elseif ($_GET['module'] == 'tambah_penduduk') {
                include "pages/penduduk/tambah_penduduk.php";
            } elseif ($_GET['module'] == 'update_penduduk') {
              include "pages/penduduk/update_penduduk.php";
            }elseif ($_GET['module'] == 'hapus_penduduk') {
              include "pages/penduduk/aksi_hapus.php";
            }elseif ($_GET['module'] == 'hapus_semua_penduduk') {
              include "pages/penduduk/aksi_hapus_semua.php";
            }elseif ($_GET['module'] == 'list_hasil') {
              include "pages/hasil/list_hasil.php";
            }elseif ($_GET['module'] == 'hitung') {
              include "pages/hasil/hitung.php";
            }elseif ($_GET['module'] == 'list_detail_penduduk') {
              include "pages/hasil/list_penduduk.php";
            }elseif ($_GET['module'] == 'hapus_hasil') {
              include "pages/hasil/aksi_hapus.php";
            }elseif ($_GET['module'] == 'hapus_hasil_penduduk') {
              include "pages/hasil/aksi_hapus_hasil_penduduk.php";
            }
    ...
    <footer class="site-footer" style="margin-top: 40vh;">
      <div class="text-center">
        <p>
          &copy; Copyrights <strong>DESA NAMBAKAN</strong>. All Rights Reserved
        </p>
        <div class="credits">
          <!--
